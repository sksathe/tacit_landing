...
export function StartSessionModal({ open, onClose }: StartSessionModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-panel border-2 border-primary rounded-[20px] p-12 max-w-[800px] w-[90%] max-h-[90vh] overflow-y-auto relative"
      ...
      >
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-6 mb-8">
          {agents.map((agent) => (
            <div
              ...
              className={`bg-card border-2 rounded-2xl p-6 cursor-pointer transition-all text-center ${
        ...
        <form onSubmit={handleSubmit} className="mt-8">
          ...
          <div className="mb-6">
            <label htmlFor="inviteeEmail" className="block text-primary font-semibold mb-2 text-[0.95rem]">
              SME Email (Invitee)
            </label>
            <input
              type="email"
          ...
          <div className="mb-6">
            <label htmlFor="sessionNotes" className="block text-primary font-semibold mb-2 text-[0.95rem]">
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-input border-2 border-primary/30 rounded-lg px-4 py-3 text-foreground text-base transition-all focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 resize-none min-h-[100px]"
            />
          </div>
          ...
          <button
            ...
            className="w-full bg-primary text-primary-foreground px-5 py-4 rounded-xl text-[1.1rem] font-bold cursor-pointer transition-all border-none shadow-[var(--shadow-button-lg)] hover:opacity-90 hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 mt-4"
          >
            Submit & Send Invite
          </button>
        </form>
